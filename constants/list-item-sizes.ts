/**
 * Measured item heights for FlashList estimatedItemSize prop.
 * These are approximate heights in dp. Measure using onLayout if accuracy matters.
 * Update when item layout changes significantly (>20dp difference).
 */
