...
export async function downloadAndSavePDF(
  ...
  try {
    ...
    showToast(i18n.t('common.savingPDF', { ns: 'common', defaultValue: 'Đang lưu file PDF...' }))
    ...
    const { setIsDownloading, setProgress, progress: currentProgress } = useDownloadStore.getState()
      ...
      try {
        ...
        if (androidVersion < 33) {
          const granted = await PermissionsAndroid.request(
            ...
            {
              title: i18n.t('common.saveImagePermissionTitle', { ns: 'common', defaultValue: 'Quyền lưu file' }),
              message: i18n.t('common.saveImagePermissionMessage', { ns: 'common', defaultValue: 'Ứng dụng cần quyền lưu file PDF vào thư mục Downloads' }),
              buttonNeutral: i18n.t('common.cancel', { ns: 'common', defaultValue: 'Để sau' }),
              buttonNegative: i18n.t('common.cancel', { ns: 'common', defaultValue: 'Từ chối' }),
              buttonPositive: i18n.t('common.confirm', { ns: 'common', defaultValue: 'Đồng ý' }),
            }
          )
          ...
          if (granted !== PermissionsAndroid.RESULTS.GRANTED) {
            ...
            Alert.alert(
              i18n.t('common.permissionDenied', { ns: 'common', defaultValue: 'Quyền bị từ chối' }),
              i18n.t('common.permissionRequired', { ns: 'common', defaultValue: 'Cần quyền lưu file để tải PDF. Vui lòng cấp quyền trong cài đặt.' }),
              [
        ...
        setIsDownloading(false)
        showToast(i18n.t('common.errorRequestingPermission', { ns: 'common', defaultValue: 'Lỗi khi xin quyền lưu file' }))
        return false
      }
    }
    ...
    if (Platform.OS === 'web') {
      setIsDownloading(false)
      showToast(i18n.t('common.errorSavingPDF', { ns: 'common', defaultValue: 'Lỗi khi lưu file PDF' }))
      // eslint-disable-next-line no-console
    ...
    const RNFS = await import('react-native-fs').then(m => m.default).catch(() => null)
    if (!RNFS) {
      setIsDownloading(false)
      showToast(i18n.t('common.errorSavingPDF', { ns: 'common', defaultValue: 'Lỗi khi lưu file PDF' }))
      return false
    ...
    try {
      ...
      if (Platform.OS === 'android') {
        showToast(i18n.t('common.fileSavedToDownloads', { ns: 'common', defaultValue: 'Đã lưu PDF vào thư mục Downloads' }))
      } else {
        showToast(i18n.t('common.fileSavedToFilesApp', { ns: 'common', defaultValue: 'Đã lưu PDF. Mở Files app để xem' }))
      }
      ...
      if (errorMessage.includes('permission') || errorMessage.includes('Permission')) {
        showToast(i18n.t('common.noPermissionToSave', { ns: 'common', defaultValue: 'Không có quyền lưu file. Vui lòng cấp quyền trong cài đặt' }))
        Alert.alert(
          i18n.t('common.permissionDenied', { ns: 'common', defaultValue: 'Quyền bị từ chối' }),
          i18n.t('common.permissionRequired', { ns: 'common', defaultValue: 'Cần quyền lưu file để tải PDF. Vui lòng cấp quyền trong cài đặt.' }),
          [
